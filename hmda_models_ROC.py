...
csv_file_path = '/Users/yeshimonipede/Documents/ADEC743001/2023Fall_ADEC743001/cleaned_data.csv'
...
# Convert '2.0' to '1' in y_test and y_prob - 2 means that the loan got approved (now represented as 1 for the function)
y_test_binary = y_test.replace({1.0: 0, 2.0: 1})
y_prob_binary = rf_model.predict_proba(X_test)[:, 1]  # Probability for the positive class
...
# Convert '2.0' to '1' in y_test and y_prob - 2 means that the loan got approved (now represented as 1 for the function)
y_test_binary = y_test.replace({1.0: 0, 2.0: 1})
y_prob_binary = log_model.predict_proba(X_test)[:, 1]  # Probability for the positive class
